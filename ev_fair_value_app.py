...
st.title("\uc0\u55357 \u56520  Stock Fair Value Estimator (EV/EBITDA Method)")\
\
...
if uploaded_file is not None:\
    ...
    if "Symbol" not in df.columns:\
        ...
        for ticker in df["Symbol"]:\
            st.write(f"\uc0\u55357 \u56589  Evaluating: \{ticker\}")\
...
\
            ...
            st.download_button("\uc0\u55357 \u56549  Download Full Report as CSV", data=csv, file_name="fair_value_report.csv", mime="text/csv")\
        else:\
